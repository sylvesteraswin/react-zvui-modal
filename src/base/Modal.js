...
class Modal extends Component {
  ...
  static defaultProps = {
    ...
    renderLoader: props =>
      <div {...props}>
        <div className={props.loaderIconClassName} />
      </div>,
  };
  ...
  componentWillUnmount = () => {
    const { active, transition } = this.props;
  ...
  renderLoader = () => {
    ...
    let loader = (
      ...
      >
        <div className={`${loaderIconClassName}`} />
      </div>
    );

    if (Transition) {
      loader = (
        <Transition in={this.props.active} timeout={loaderTransitionTimeout}>
          {renderLoader({
            ref: loaderRef,
            style: loaderStyle,
            className: cn(loaderClassName, {
  ...
  renderBackdrop = () => {
    ...
    if (Transition) {
      backdrop = (
        <Transition in={this.props.active} timeout={backdropTransitionTimeout}>
          {renderBackdrop({
            ref: backdropRef,
            style: backdropStyle,
            className: cn(backdropClassName, {
  ...
  focus = () => {
    ...
    const focusInModal =
      current && modalContent && contains(modalContent, current);

    if (modalContent && autoFocus && !focusInModal) {
      this.lastFocus = current;

      if (
        typeof modalContent.hasAttribute === 'function' &&
  ...
  render = () => {
    ...
    return (
      <Teleport ref={this.setMountNode} container={container}>
        <div
