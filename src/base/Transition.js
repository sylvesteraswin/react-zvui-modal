...
const { end: transitionEndEvent } = transitionInfo;
...
class Transition extends Component {
    ...
    state = {
        status: (() => {
            let initialStatus;
            if (this.props.in) {
                initialStatus = this.props.transitionAppear ? EXITED : ENTERED;
            } else {
                initialStatus = this.props.unmountOnExit ? UNMOUNTED : EXITED;
            }
    ...
    render = () => {
        ...
        Object.keys(Transition.propTypes).forEach(
            key => delete childProps[key]
        );
