...
const findTheBlackSheeps = (obj, keys) =>
...
class ZvuiModal extends Component {
  ...
  _getStyles = () => {
    ...
    const { container, full } = this.props;
  ...
  render = () => {
    ...
    const { dialog, classes, backdrop, dialogStyle } = this.state;

    delete props.manager;
    const elementProps = findTheBlackSheeps(
      props,
      Object.keys(ZvuiModal.propTypes),
    );
    ...
    const modal = (
      ...
      >
        <div
          ...
          style={dialogStyle}
          className={cn(`${prefix}-dialog`, dialogClassName, classes, {
